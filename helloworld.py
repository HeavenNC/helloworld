...
line = LINE()
line = LINE("Er5tao0McHiwXqLQFwv7.NJBaaPWX4ChwW2QkFbp+nW.yef2jeqZFD4Hr/09TpXMHD7WklSzxSfKtrOa2Cg1RQE=")
#line = LINE("","Password")
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendContact(to, "u9e36c0029c31e1c1d6c36a8a7c13ff37")
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "Gak Usah Ngegas Anjeng")
                    elapsed_time = time.time() - start
                    line.sendMessage(to,format(str(elapsed_time)))
                elif text.lower() == 'restart':
                    line.sendMessage(to, "Sabar Anjeng")
                    line.sendMessage(to, "Sudah Anjeng")
                    restartBot()
